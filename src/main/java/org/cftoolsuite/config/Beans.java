    ...
    static class Simple {
        ...
        public RefactoringService refactoringService(
            ...
            return new SimpleSourceRefactoringService(
                chatClientBuilder, prompt, gitClient, tpmDelay, pullRequestClientFactory);
        }
    }
    ...
    static class Advanced {
        ...
        public RefactoringService refactoringService(
            ...
            return new DependencyAwareRefactoringService(
                chatClientBuilder, seek, prompt, gitClient, pullRequestClientFactory, gitRepositoryIngester, store);
        }
